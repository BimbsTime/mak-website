...
export function IntroSection() {
  return (
    <section
      ...
      className="w-full bg-[var(--background)] px-6 py-[48px] md:px-12 md:py-[48px] xl:px-80"
    >
      <div className="mx-auto flex max-w-[1177px] flex-col items-center gap-6 md:gap-12">
