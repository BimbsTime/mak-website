        ...
        <div className="mt-10 w-full md:mt-[56px]">
          ...
          >
            ...
            <div className={`absolute inset-0 flex items-center justify-center bg-black/65 p-6 text-center transition-opacity duration-300 md:p-10 ${
              ...
              <p className="max-w-[620px] font-body text-[24px] leading-10 font-extralight tracking-[0.04em] text-white">{verticalGalleryCaptions[0]}</p>
            </div>
          </div>
          <div className="mt-1 grid grid-cols-1 gap-1 md:h-svh md:grid-cols-[3fr_2fr] md:min-h-0">
            ...
            >
              ...
              <div className={`absolute inset-0 flex items-center justify-center bg-black/65 p-6 text-center transition-opacity duration-300 md:p-10 ${
                ...
                <p className="max-w-[620px] font-body text-[24px] leading-10 font-extralight tracking-[0.04em] text-white">{verticalGalleryCaptions[1]}</p>
              </div>
            </div>
            <div
              role="button"
            ...
            >
              ...
              <div className={`absolute inset-0 flex items-center justify-center bg-black/65 p-6 text-center transition-opacity duration-300 md:p-10 ${
                ...
                <p className="max-w-[620px] font-body text-[24px] leading-10 font-extralight tracking-[0.04em] text-white">{verticalGalleryCaptions[2]}</p>
              </div>
            </div>
          </div>
        </div>
