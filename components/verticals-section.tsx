...
export function VerticalsSection() {
  ...
  return (
    <section id="verticals" className="w-full py-[32px] md:py-[32px]">
      <div className="mx-auto max-w-[1615px] px-6 md:px-20">
        <div className="flex flex-col gap-4 md:max-w-[1114px] md:flex-row md:items-end md:gap-14">
          <h2 className="max-w-[510px] font-display text-[24px] leading-[26px] text-[var(--brand)] md:text-[40px] md:leading-[40px]">
