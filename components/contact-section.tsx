          ...
          <ScrollReveal delay={340}>
            <div className="mt-2">
              <button
                ...
                className="inline-flex min-h-12 items-center justify-center bg-[rgba(247,242,233,0.85)] px-10 py-3 font-display text-[20px] leading-[21px] font-light text-[var(--brand)] transition-[background-color] duration-300 hover:bg-[rgba(247,242,233,1)] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white md:px-24"
              >
                Get in touch
              </button>
            </div>
